              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="input-group">
                    <input id="new-event" type="text" class="form-control" placeholder="Judul kegiatan">
...
<script src="<?= base_url() ?>assets/AdminLTE/plugins/fullcalendar/locales/id.js"></script>
