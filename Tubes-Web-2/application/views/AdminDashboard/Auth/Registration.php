...
<head>
  ...
  <title>Real - Estate | Registration Page</title>
    ...
    <div class="card-body">
      ...
      <form action="<?= base_url('auth/registration') ?>" method="post">
        ...
        <div class="form-group mb-3">
          <div class="input-group">
            <input type="text" class="form-control" placeholder="Phone number" id="phone" name="phone" value="<?= set_value('phone'); ?>">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <?= form_error('phone', '<div class="text-danger small">', '</div>'); ?>
        </div>
