...
<?php $this->load->view('include/sidebar.php')?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<?= base_url('admindash/send_email') ?>" class="btn btn-primary btn-block mb-3">Compose</a>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="<?= base_url()?>admindash/read_email">Alexander Pierce</a></td>
