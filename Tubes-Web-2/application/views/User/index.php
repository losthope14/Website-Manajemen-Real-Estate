        ...
        <div class="row">
                ...
                <div class="card property-box-2">
                    ...
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            <img src="<?= base_url() ?>assets/UserView/img/property-3.jpg" alt="property-3" class="img-fluid">
                        </a>
                        <div class="property-overlay">
                            ...
                            <div class="property-magnify-gallery">
                                ...
                                <a href="<?= base_url() ?>assets/UserView/img/property-7.jpg" class="hidden"></a>
                                <a href="<?= base_url() ?>assets/UserView/img/property-6.jpg" class="hidden"></a>
                            </div>
                        </div>
                    </div>
                    <!-- detail -->
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp delay-04s">
                <div class="card property-box-2">
                    ...
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            <img src="<?= base_url() ?>assets/UserView/img/property-7.jpg" alt="property-7" class="img-fluid">
                        </a>
                        <div class="property-overlay">
                            <a href="properties-details.html" class="overlay-link">
                                <i class="fa fa-link"></i>
                            ...
                            <div class="property-magnify-gallery">
                                <a href="<?= base_url() ?>assets/UserView/img/property-7.jpg" class="overlay-link">
                                    <i class="fa fa-expand"></i>
                                </a>
                                <a href="<?= base_url() ?>assets/UserView/img/property-4.jpg" class="hidden"></a>
                                <a href="<?= base_url() ?>assets/UserView/img/property-3.jpg" class="hidden"></a>
                            </div>
                        </div>
                    </div>
                    <!-- detail -->
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp delay-04s">
                <div class="card property-box-2">
                    ...
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            <img src="<?= base_url() ?>assets/UserView/img/property-5.jpg" alt="property-5" class="img-fluid">
                        </a>
                        <div class="property-overlay">
                            <a href="properties-details.html" class="overlay-link">
                                <i class="fa fa-link"></i>
                            ...
                            <div class="property-magnify-gallery">
                                <a href="<?= base_url() ?>assets/UserView/img/property-5.jpg" class="overlay-link">
                                    <i class="fa fa-expand"></i>
                                </a>
                                <a href="<?= base_url() ?>assets/UserView/img/property-7.jpg" class="hidden"></a>
                                <a href="<?= base_url() ?>assets/UserView/img/property-6.jpg" class="hidden"></a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInRight delay-04s">
                <div class="card property-box-2">
                    ...
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            <img src="<?= base_url() ?>assets/UserView/img/property-1.jpg" alt="property-1" class="img-fluid">
                        </a>
                        <div class="property-overlay">
                            <a href="properties-details.html" class="overlay-link">
                                <i class="fa fa-link"></i>
                            ...
                            <div class="property-magnify-gallery">
                                <a href="<?= base_url() ?>assets/UserView/img/property-1.jpg" class="overlay-link">
                                    <i class="fa fa-expand"></i>
                                </a>
                                <a href="<?= base_url() ?>assets/UserView/img/property-7.jpg" class="hidden"></a>
                                <a href="<?= base_url() ?>assets/UserView/img/property-3.jpg" class="hidden"></a>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInLeft delay-04s">
                <div class="property-box-8">
                    <div class="property-photo">
                        <img src="<?= base_url() ?>assets/UserView/img/property-3.jpg" alt="property-6" class="img-fluid">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp delay-04s">
                <div class="property-box-8">
                    <div class="property-photo">
                        <img src="<?= base_url() ?>assets/UserView/img/property-6.jpg" alt="property-6" class="img-fluid">
                        <div class="date-box">For Sale</div>
                    </div>
                    <div class="detail">
                        <div class="heading">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp delay-04s">
                <div class="property-box-8">
                    <div class="property-photo">
                        <img src="<?= base_url() ?>assets/UserView/img/property-2.jpg" alt="property-2" class="img-fluid">
                        <div class="date-box">For Sale</div>
                    </div>
                    <div class="detail">
                        <div class="heading">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow fadeInRight delay-04s">
                <div class="property-box-8">
                    <div class="property-photo">
                        <img src="<?= base_url() ?>assets/UserView/img/property-1.jpg" alt="property-6" class="img-fluid">
                        <div class="date-box">For Sale</div>
                    </div>
                    <div class="detail">
                        <div class="heading">
...
<!-- Testimonial 2 start -->
<div class="testimonial-2 overview-bgi" style="background-image: url(<?= base_url() ?>assets/UserView/img/testimonial-property.jpg)">
    <div class="container">
        <div class="row">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="<?= base_url() ?>assets/UserView/img/avatar/avatar.jpg" alt="avatar" class="img-fluid rounded">
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <p class="lead">
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        <div class="avatar">
                                            <img src="<?= base_url() ?>assets/UserView/img/avatar/avatar-3.jpg" alt="avatar-3" class="img-fluid rounded">
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <p class="lead">
            ...
            <div class="multi-carousel-inner">
                <div class="item">
                    <div class="pad15">
                        ...
                        <img src="<?= base_url() ?>assets/UserView/img/brands/brand-1.png" alt="brand">
                    </div>
                </div>
                <div class="item">
                    <div class="pad15">
                        <p class="lead">Codecanyon</p>
                        <img src="<?= base_url() ?>assets/UserView/img/brands/brand-2.png" alt="brand">
                    </div>
                </div>
                <div class="item">
                    <div class="pad15">
                        <p class="lead">Graphicriver</p>
                        <img src="<?= base_url() ?>assets/UserView/img/brands/brand-3.png" alt="brand">
                    </div>
                </div>
                <div class="item">
                    <div class="pad15">
                        <p class="lead">Themeforest</p>
                        <img src="<?= base_url() ?>assets/UserView/img/brands/brand-4.png" alt="brand">
                    </div>
                </div>
                <div class="item">
                    <div class="pad15">
                        <p class="lead">Tuts</p>
                        <img src="<?= base_url() ?>assets/UserView/img/brands/brand-5.png" alt="brand">
                    </div>
                </div>
                <div class="item">
                    <div class="pad15">
