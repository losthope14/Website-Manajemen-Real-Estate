                ...
                <div class="recent-posts footer-item">
                    ...
                    <div class="media mb-4">
                        <a href="properties-details.html">
                            <img src="<?= base_url() ?>assets/UserView/img/sub-property/sub-property.jpg" alt="sub-property">
                        </a>
                    ...
                    <div class="media mb-4">
                        <a href="properties-details.html">
                            <img src="<?= base_url() ?>assets/UserView/img/sub-property/sub-property-2.jpg" alt="sub-property-2">
                        </a>
                        <div class="media-body align-self-center">
                            <h5>
                    ...
                    <div class="media">
                        <a href="properties-details.html">
                            <img src="<?= base_url() ?>assets/UserView/img/sub-property/sub-property-3.jpg" alt="sub-property-3">
                        </a>
                        <div class="media-body align-self-center">
                            <h5>
                            ...
                            <div id="modalCarousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item">
                                        <img src="<?= base_url() ?>assets/UserView/img/property-1.jpg" alt="Test ALT">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="<?= base_url() ?>assets/UserView/img/property-1.jpg" alt="Test ALT">
                                    </div>
...
<script src="<?= base_url() ?>assets/UserView/js/jquery-2.2.0.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/popper.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/bootstrap.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/jquery.selectBox.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/rangeslider.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/jquery.magnific-popup.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/jquery.filterizr.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/wow.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/backstretch.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/jquery.countdown.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/jquery.scrollUp.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/particles.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/typed.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/dropzone.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/jquery.mb.YTPlayer.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/leaflet.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/leaflet-providers.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/leaflet.markercluster.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/slick.min.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/maps.js"></script>
<script src="<?= base_url() ?>assets/UserView/js/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB0N5pbJN10Y1oYFRd0MJ_v2g8W2QT74JE"></script>
<script src="<?= base_url() ?>assets/UserView/js/ie-emulation-modes-warning.js"></script>
<!-- Custom JS Script -->
<script  src="<?= base_url() ?>assets/UserView/js/app.js"></script>
