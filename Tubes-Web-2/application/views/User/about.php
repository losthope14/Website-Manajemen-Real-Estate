        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="properties-service-v">
                    <img src="<?= base_url() ?>assets/UserView/img/admin.png" alt="admin" class="img-fluid">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="agent-2">
                    <div class="agent-photo">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/UserView/img/avatar/avatar-5.jpg" alt="avatar-5" class="img-fluid">
                        </a>
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="agent-2">
                    <div class="agent-photo">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/UserView/img/avatar/avatar-6.jpg" alt="avatar-6" class="img-fluid">
                        </a>
                    </div>
                    <div class="agent-details">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="agent-2">
                    <div class="agent-photo">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/UserView/img/avatar/avatar-7.jpg" alt="avatar-7" class="img-fluid">
                        </a>
                    </div>
                    <div class="agent-details">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="agent-2">
                    <div class="agent-photo">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/UserView/img/avatar/avatar-11.jpg" alt="avatar-11" class="img-fluid">
                        </a>
                    </div>
                    <div class="agent-details">
...
<!-- Counters start -->
<div class="counters overview-bgi" style="background-image: url(<?= base_url() ?>assets/UserView/img/bg-photo-2.jpg)">
    <div class="container">
        <div class="row">
                    ...
                    <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <div class="avatar">
                                    <img src="<?= base_url() ?>assets/UserView/img/avatar/avatar-2.jpg" alt="avatar-2" class="img-fluid rounded">
                                </div>
                                <ul class="rating">
                                    <li>
