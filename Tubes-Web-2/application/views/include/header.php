...
<head>
  ...
  <!-- favicon -->
  <link rel="icon" type="image/png" href="<?= base_url() ?>assets/image/real-estate.png?v=1"/>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?= base_url() ?>admindash" id="dash-nav" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?= base_url() ?>admindash/view_contacts" id="contact-nav" class="nav-link">Contact</a>
      </li>
    </ul>
